 ...
 *
 * Selection Rules (6 structures scored):
 ...
 *   IF temporal locality is high       → Splay Tree
 *   IF random/mixed workload           → Treap
...
typedef enum {
    ...
    DS_SPLAY,
    DS_TREAP,
    DS_COUNT  /* Number of data structure types scored by adaptive system */
} DataStructureType;
...
typedef struct {
    ...
    double temporal_locality;   /* 0.0 = uniform, 1.0 = strong recency bias */
} WorkloadProfile;
